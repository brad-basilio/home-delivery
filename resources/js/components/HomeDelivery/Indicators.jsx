      ...
      <div className="w-full 2xl:max-w-7xl mx-auto px-[5%] 2xl:px-0 relative z-10">
        ...
        <div className="md:hidden">
          <Swiper
            ...
            className="indicators-swiper pb-16"
          >
            {indicators.map((indicator, index) => {
              ...
              return (
                <SwiperSlide key={indicator.id}>
                  <div
                    className={`group relative ${colorScheme.bg} rounded-3xl p-8 transition-all duration-500 hover:shadow-2xl cursor-default h-full`}
                  >
                    ...
                    <div className="relative flex flex-col items-center text-center space-y-4">
                      ...
                      <div className="relative">
                        ...
                        <div className="relative bg-white/20 backdrop-blur-sm p-5 rounded-full border-2 border-white/30 group-hover:border-white/50 transition-all duration-500 group-hover:rotate-12">
                          <img
                            ...
                            alt={indicator.name}
                            className={`w-14 h-14 object-contain filter ${colorScheme.icon} transition-transform duration-500 group-hover:scale-110`}
                            onError={(e) => {
                      ...
                      {/* Título */}
                      <div className={`text-3xl font-bold ${colorScheme.text} leading-tight`}>
                        {indicator.name}
                      </div>

                      {/* Descripción */}
                      {indicator.description && (
                        <div className={`text-base ${colorScheme.text} opacity-95 leading-relaxed font-medium`}>
                          {indicator.description}
                        </div>
                      )}
          ...
          <div className="custom-pagination flex justify-center gap-3 mt-8"></div>        </div>
